...
if __name__ == '__main__':
    ...
    if epochs.isdigit():
        ...
        for epoch in range(1, epochs+1):
            ...
            if epoch%5==0:
                torch.save(model.state_dict(), "trained_model_"+str(epoch)+".pth")
            print("Accuracy for ",epoch," epoch = ",round(accuracy,2))
        torch.save(model.state_dict(), "trained_model_k"+str(epoch)+".pth")
        print("Accuracy for ",epoch," epoch = ",round(accuracy,2))
